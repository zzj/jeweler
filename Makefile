...
LDFLAGS= -lz lib/bamtools/lib/libbamtools.a -lboost_system-mt -lboost_filesystem-mt  -lprotobuf lib/leveldb-1.5.0/libleveldb.a lib/glog-0.3.2/.libs/libglog.a
