...
public:
    ...
    void dump_error_rate_by_quality(Jeweler::TranscriptMismatcherAnalyzerData::IterationResult* data);

    void dump_location_results(Jeweler::TranscriptMismatcherAnalyzerData *data);
    void analyze();
private:
